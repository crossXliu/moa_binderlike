cmd_drivers/media/platform/moa/binderlike/binderlike-core.o := arm-linux-gnueabi-gcc -Wp,-MMD,drivers/media/platform/moa/binderlike/.binderlike-core.o.d  -nostdinc -isystem /usr/lib/gcc-cross/arm-linux-gnueabi/9/include -I./arch/arm/include -I./arch/arm/include/generated  -I./include -I./arch/arm/include/uapi -I./arch/arm/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/kconfig.h -include ./include/linux/compiler_types.h -D__KERNEL__ -mlittle-endian -fmacro-prefix-map=./= -Wall -Wundef -Werror=strict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -fshort-wchar -fno-PIE -Werror=implicit-function-declaration -Werror=implicit-int -Werror=return-type -Wno-format-security -std=gnu89 -fno-dwarf2-cfi-asm -fno-ipa-sra -mabi=aapcs-linux -mfpu=vfp -funwind-tables -marm -Wa,-mno-warn-deprecated -D__LINUX_ARM_ARCH__=7 -march=armv7-a -msoft-float -Uarm -fno-delete-null-pointer-checks -Wno-frame-address -Wno-format-truncation -Wno-format-overflow -Wno-address-of-packed-member -O2 --param=allow-store-data-races=0 -Wframe-larger-than=1024 -fstack-protector-strong -Wno-unused-but-set-variable -Wimplicit-fallthrough -Wno-unused-const-variable -fomit-frame-pointer -g -Wdeclaration-after-statement -Wvla -Wno-pointer-sign -Wno-stringop-truncation -Wno-array-bounds -Wno-stringop-overflow -Wno-restrict -Wno-maybe-uninitialized -fno-strict-overflow -fno-stack-check -fconserve-stack -Werror=date-time -Werror=incompatible-pointer-types -Werror=designated-init -Wno-packed-not-aligned    -DKBUILD_MODFILE='"drivers/media/platform/moa/binderlike/binderlike"' -DKBUILD_BASENAME='"binderlike_core"' -DKBUILD_MODNAME='"binderlike"' -c -o drivers/media/platform/moa/binderlike/binderlike-core.o drivers/media/platform/moa/binderlike/binderlike-core.c

source_drivers/media/platform/moa/binderlike/binderlike-core.o := drivers/media/platform/moa/binderlike/binderlike-core.c

deps_drivers/media/platform/moa/binderlike/binderlike-core.o := \
  ...
  drivers/media/platform/moa/binderlike/binderlike-core.h \
  include/linux/io.h \

drivers/media/platform/moa/binderlike/binderlike-core.o: $(deps_drivers/media/platform/moa/binderlike/binderlike-core.o)
